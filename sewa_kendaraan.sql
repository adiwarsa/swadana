...
(1, 'I GEDE ADI WARSA LIMITHA', 'Bank Mandiri', 14500235648787, '2023-02-25 05:37:44', '2022-11-28 05:14:15');
...
CREATE TABLE `cars` (
  ...
  `plat` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `cars` (`id`, `vendor_id`, `nama_mobil`, `plat`, `slug`, `harga_sewa`, `denda`, `samsat`, `gambar`, `bahan_bakar`, `jumlah_kursi`, `transmisi`, `status`, `deskripsi`, `remind`, `created_at`, `updated_at`) VALUES
(10, 2, 'Avanza', 'DK 8782 PN', 'avanza', 150000, 50000, '2023-03-08', 'Avanza-1677164133.jpeg', 'Pertamax', 4, 'otomatis', 'tersedia', 'Avanza 2016', 1, '2022-11-29 09:47:10', '2023-02-27 22:37:07'),
(13, 3, 'Xenia', 'DK 0182 PJ', 'xenia', 150000, 50000, '2023-02-22', 'Xenia-1676988813.jpg', 'Pertamax', 4, 'otomatis', 'tersedia', 'Xenia 2016', 1, '2023-02-08 15:36:55', '2023-02-27 22:36:29'),
(15, 3, 'Karimun', 'DK 4521 K', 'karimun', 80000, 50000, '2023-04-05', 'Karimun-1676988936.png', 'Pertamax', 4, 'otomatis', 'tersedia', 'Karimun 2014', 0, '2023-02-21 06:15:36', '2023-02-27 22:31:39'),
(16, 3, 'APV', 'DK 3231 T', 'apv', 120000, 50000, '2023-03-21', 'APV-1676989048.png', 'Pertamax', 6, 'manual', 'tidak tersedia', 'APV 2014', 0, '2023-02-21 06:17:28', '2023-02-27 22:41:51'),
(17, 3, 'Jimny Katana', 'DK 8763 TK', 'jimny-katana', 100000, 50000, '2023-03-23', 'Jimny Katana-1676989200.png', 'Pertamax', 2, 'manual', 'tersedia', 'Jimny Katana 2010', 0, '2023-02-21 06:20:00', '2023-02-22 22:24:39'),
(18, 2, 'Jazz', 'DK 2873 UI', 'jazz', 80000, 50000, '2023-05-10', 'Jazz-1677133332.jpg', 'Pertamax', 2, 'otomatis', 'tersedia', 'Honda Jazz', 0, '2023-02-22 22:22:13', '2023-02-22 22:22:13'),
(19, 1, 'Alya', 'DK 9898 R', 'alya', 150000, 100000, '2023-04-29', 'Alya-1677564599.jpeg', 'Pertamax', 4, 'manual', 'tersedia', NULL, 0, '2023-02-27 22:10:00', '2023-02-27 22:10:00');
...
CREATE TABLE `motors` (
  `id` bigint UNSIGNED NOT NULL,
  `nama_motor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `motors` (`id`, `nama_motor`, `plat`, `slug`, `harga_sewa`, `denda`, `samsat`, `gambar`, `bahan_bakar`, `transmisi`, `status`, `deskripsi`, `remind`, `created_at`, `updated_at`, `vendor_id`) VALUES
(2, 'NMAX', 'DK 7271 K', 'nmax', 100000, 50000, '2023-02-06', '-1677164172.png', 'Pertamax', 'otomatis', 'tersedia', 'Honda NMAX 2020', 1, '2023-02-07 05:43:02', '2023-02-27 22:40:38', 21),
(3, 'Filano', 'DK 2225 R', 'filano', 100000, 50000, '2023-02-08', '-1675900226.png', 'Pertamax', 'otomatis', 'tersedia', '123', 1, '2023-02-07 06:08:37', '2023-02-22 22:30:25', 20),
(5, 'Scoopy', 'DK 7688 FI', 'scoopy', 50000, 50000, '2023-03-08', '-1676989626.png', 'Pertalite', 'otomatis', 'tidak tersedia', 'Scoopy 2020', 1, '2023-02-21 06:27:06', '2023-02-27 22:42:25', 21),
(6, 'Vario', 'DK 6842 UR', 'vario', 50000, 50000, '2023-04-21', '-1676989743.png', 'Pertalite', 'otomatis', 'tersedia', 'Vario 2021', 0, '2023-02-21 06:29:03', '2023-02-22 22:30:58', 21),
(7, 'Vespa', 'DK 4946 KF', 'vespa', 100000, 50000, '2023-04-13', '-1676989793.webp', 'Pertamax', 'otomatis', 'tersedia', 'Vespa 2022', 0, '2023-02-21 06:29:53', '2023-02-22 22:31:27', 24),
(8, 'PCX', 'DK 6912 BN', 'pcx', 100000, 50000, '2023-04-20', '-1677133983.png', 'Pertamax', 'otomatis', 'tersedia', 'PCX 2022', 0, '2023-02-22 22:33:03', '2023-02-22 22:33:03', 20);
...
CREATE TABLE `rent_logs` (
  ...
  `return_at` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(59, 'ANACOR20230228', 3, 10, NULL, '2023-02-28', 'Office', '2023-03-02', '2023-02-28', 'Airport', 300000, 0, 1, NULL, '2023-02-27 22:20:30', '2023-02-27 22:32:09'),
(60, 'APVCOR20230228', 3, 16, NULL, '2023-02-26', 'Office', '2023-02-28', '2023-02-28', 'Office', 240000, 0, 1, NULL, '2023-02-27 22:30:25', '2023-02-27 22:30:56'),
(61, 'XNACOR20230228', 3, 13, NULL, '2023-02-28', 'Office', '2023-03-01', '2023-02-28', 'Office', 150000, 0, 1, NULL, '2023-02-27 22:33:20', '2023-02-27 22:33:52'),
(62, 'XNACOR20230228', 3, 13, NULL, '2023-02-28', 'Office', '2023-02-28', '2023-02-28', 'Office', 0, 0, 1, NULL, '2023-02-27 22:36:15', '2023-02-27 22:36:29'),
(63, 'ANACOR20230228', 3, 10, NULL, '2023-02-28', 'Office', '2023-03-02', '2023-02-28', 'Office', 300000, 0, 1, NULL, '2023-02-27 22:36:53', '2023-02-27 22:37:07'),
(64, 'NAXBDS20230228', 27, NULL, 2, '2023-02-28', 'Office', '2023-03-02', '2023-02-28', 'Office', 200000, 0, 1, NULL, '2023-02-27 22:39:15', '2023-02-27 22:40:38'),
(65, 'APVCOR20230228', 3, 16, NULL, '2023-02-23', 'Office', '2023-02-24', NULL, NULL, 120000, NULL, 1, NULL, '2023-02-27 22:41:51', '2023-02-27 22:41:51'),
(66, 'SOYCOR20230228', 3, NULL, 5, '2023-02-22', 'Office', '2023-02-26', NULL, NULL, 200000, NULL, 1, NULL, '2023-02-27 22:42:25', '2023-02-27 22:42:25');
...
(1, 1, 'Admin', 'admin@gmail.com', '$2y$10$ugjRO4b2sxyGx2I69Y.6UeLfqRoMYI.eNa.WXI76JmSlx1OzcZU.a', NULL, '089621791541', 'Jl. Badak Agung', 'active', NULL, NULL, '2023-02-27 22:02:08'),
...
(30, 2, 'Khalafina', 'kalafina@gmail.com', '$2y$10$./guIYB.9PDvTKr6BlHFAeTucV7iz9t5iLvFeEwKqNo49.m6NjYI6', '', '089776453219', 'Jl. Jayagiri 5', 'active', NULL, '2023-02-27 22:04:49', '2023-02-27 22:04:49');
