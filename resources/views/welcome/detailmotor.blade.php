<x-landingpage bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Detail Motorcycle</h1>
            </div>
        </div>
    </header>
    <!-- Section-->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="{{ asset('storage/gambar/' . $motor->gambar) }}"
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="rent-price mb-3">
                                        <span style="font-size: 1rem"
                                            class="text-primary">Rp.{{ $motor->harga_sewa }}/</span>day
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="addnew" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
          <form name="rent_add" id="rent_add" class="form-horizontal" action="{{ route('rentCustomermotor-add', $motor->slug) }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="modal-content">
                  <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Rent a Motorcycle</h5>
