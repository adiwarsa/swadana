<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Rent Motor" Pages="Rent Logs"></x-navbars.navs.auth>
        <!-- End Navbar -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (empty($item->actual_return_date) && $item->status == 1)
                                                    <a href="javascript:void(0)" class="btn-edit badge badge-sm bg-gradient-success" data-attr="{{ route('rentmotor-return', $item->id) }}">Return</a>
                                                @else
        ...
        buttons: [
            {
                ...
                customize: function ( win ) {
                    ...
                    $(win.document.body)
                        ...
                        if (startDate && endDate) {
                    win.document.title = `Rent Motor Transaction (${startDate} - ${endDate})`;
                } if(startDate){
                    win.document.title = `Rent Motor Transaction (${startDate})`;
                }else {
                    win.document.title = 'Rent Motor Transaction';
                }
                }
            },{
                extend: 'pageLength',
