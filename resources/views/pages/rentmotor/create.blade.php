<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Add Rent Motor" Pages="Rent Logs"></x-navbars.navs.auth>
        <!-- End Navbar -->
            @if ($errors->any())
                ...
                <div class="card-body">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select required name="motor_id" id="motor" class="form-control border border-2 p-2 boxselect">
