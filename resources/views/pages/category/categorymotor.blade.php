<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    <x-navbars.sidebar activePage="Category Motor"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Category Motor" Pages="Vehicle"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            ...
                            <div class=" me-3 my-3 text-end">
                                {{-- <a class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" id="#addnew" data-bs-target="#addnew" href="javascript:;"><i
                                    ...
                                    Vendor</a> --}}
                                    <a class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" id="categorymotor_add" data-bs-target="#addnew" href="javascript:void(0)"><i
                                        class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New
                                    Category</a>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                ...
                                                {{-- <a href="category-edit/{{ $item->slug }}" class="badge badge-sm bg-gradient-success">Edit</a> --}}
                                                <a href="javascript:void(0)" class="btn-edit badge badge-sm bg-gradient-success" data-attr="{{ route('category-edit', $item->slug) }}">Edit</a>
                                                <form class="delform" method="POST" action="{{ route('category-delete', $item->slug) }}">
                                                    @csrf
                                                    @method('DELETE')
  ...
  <div class="modal fade" id="addnew" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form name="categorymotor_add" id="categorymotor_add" class="form-horizontal" action="{{ route('categorymotor-add') }}" method="POST" enctype="multipart/form-data">
            @csrf
