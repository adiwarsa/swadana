                ...
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <input type="number" id="rupiah" name="harga_sewa" class="form-control border border-2 p-2" value="{{ $motor->harga_sewa }}">
                            <label for="rupiah">*Rp. {{ number_format($motor->harga_sewa, 0, '', '.') }}</label>
                        </div>
                        <div class="col-md-6">
                            <label for="denda">Fine</label>
                            <input type="number" id="rupiahdenda" name="denda" class="form-control border border-2 p-2" value="{{ $motor->denda }}">
                            <label for="rupiahdenda">*Rp. {{ number_format($motor->denda, 0, '', '.') }}</label>
                        </div>
                    </div>
                    <div class="row mt-2">
