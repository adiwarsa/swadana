<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    <x-navbars.sidebar activePage="Motor Table"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Motor Table" Pages="Vehicle"></x-navbars.navs.auth>
        <!-- End Navbar -->
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Motor table</h6>
                            </div>
                            <div class=" me-3 my-3 text-end">
                                {{-- <a class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" id="#addnew" data-bs-target="#addnew" href="javascript:;"><i
                                        class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New
                                    Vendor</a> --}}
                                    <a class="btn bg-gradient-dark mb-0" data-bs-target="#addnew" href="{{ route('motor-create') }}"><i
                                        class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New
                                    Motor</a>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center mb-0" id="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            onclick="modalDetail('{{ route('motor-detail', $item->id) }}', 'Motor Detail', 'modal-dialog-scrollable modal-md')">Info</a>
                                                <a href="motor-edit/{{$item->slug}}" class="badge badge-sm bg-gradient-success">Edit</a>
                                                <form class="delform" method="POST" action="{{ route('motor-delete', $item->slug) }}">
                                                    @csrf
                                                    @method('DELETE')
