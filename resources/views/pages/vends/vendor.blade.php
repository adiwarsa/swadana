<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Vendor Car" Pages="Vehicle"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            ...
                            <div class=" me-3 my-3 text-end">
                                {{-- <a class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" id="#addnew" data-bs-target="#addnew" href="javascript:;"><i
                                    ...
                                    Vendor</a> --}}
                                    <a class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" id="vendor_add" data-bs-target="#addnew" href="javascript:void(0)"><i
                                        class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New
                                    Vendor</a>
                            </div>
                        </div>
  ...
  <div class="modal fade" id="addnew" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form name="vendor_add" id="vendor_add" class="form-horizontal" action="{{route('vendor-add')}}" method="POST" enctype="multipart/form-data">
            @csrf
