...
<style>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Rent Car" Pages="Rent Logs"></x-navbars.navs.auth>
        <!-- End Navbar -->
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0 table" id="tablerent">
                                    <thead>
                                        <tr>
                                            <th
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if($item->actual_return_date == '')
                                                ...
                                                @endif
                                            @else
                                            <button class="btn badge badge-sm bg-gradient-success">Car Returned</button>
                                            @endif
                                            ...
                                            <a href="javascript:void(0)" class="badge badge-sm bg-gradient-info" title="Klik Untuk Melihat Detail Data"
                                                onclick="modalDetail('{{ route('rent-detail', $item->id) }}', 'Rent Detail', 'modal-dialog-scrollable modal-md')">Info</a>
...
if (startDate && endDate) {
  title = `Swadana Bali <br> Rent Car Transaction <br> (${startDate} - ${endDate}) <hr>`;
} else if (startDate) {
  title = `Swadana Bali <br> Rent Car Transaction <br> (${startDate}) <hr>`;
}
