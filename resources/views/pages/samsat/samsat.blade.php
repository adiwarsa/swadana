<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    <x-navbars.sidebar activePage="samsat"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Samsat Car" Pages="Samsat"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            ...
                            <div class=" me-3 my-3 text-end">
                                {{-- <a class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" id="#addnew" data-bs-target="#addnew" href="javascript:;"><i
                                    ...
                                    Vendor</a> --}}
                                    <a class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" id="samsat_add" data-bs-target="#addnew" href="javascript:void(0)"><i
                                        class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New
                                    Samsat</a>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center mb-0" id="tablesamsat">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $item->car->nama_mobil }}</p>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)" class="btn-edit badge badge-sm bg-gradient-success" data-attr="{{ route('samsat-renew-edit', $item->id) }}">Renew</a>
                                                 @else
                                            ...
                                            onclick="modalDetail('{{ route('samsat-detail', $item->id) }}', 'Samsat Detail', 'modal-dialog-scrollable modal-md')">Info</a>
  ...
  <div class="modal fade" id="addnew" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form name="samsat_add" id="samsat_add" class="form-horizontal" action="{{route('samsat-add')}}" method="POST" enctype="multipart/form-data">
            @csrf
      <div class="modal-content">
        ...
        <div class="modal-body">
            <h4 class="col-lg-6">Samsat Car</h4>
