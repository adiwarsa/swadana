<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage='User Profile' Pages="User"></x-navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="row gx-4 mb-2">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                                @if (auth()->user()->gambar!='')
                                <img src="{{ asset('storage/profile/'.auth()->user()->gambar) }}" 
                                class="w-100 border-radius-lg shadow-sm" alt="profile_image">
                                @else
                ...
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        ...
                        @endif
                        <form method="POST" action="{{ route('save-user-profile') }}">
                            @csrf
                            <div class="row">
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <label for="currentImage" style="display: block">Current Profile Picture</label>
                                    @if (auth()->user()->gambar!='')
                                        <img src="{{ asset('storage/profile/'.auth()->user()->gambar) }}" alt="" class="w-25 border-radius-lg shadow-sm">   
                                    @endif
                                </div> --}}
                            </div>
                            <button type="submit" class="btn bg-gradient-dark mt-2">Save</button>
                        </form>
                        ...
                        <form method="POST" action="{{ route('change-password') }}">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                    <button type="submit" class="btn bg-gradient-dark mt-2">Change Password</button>
                        </form>
